...
export class textarea_ extends SmartdomElement_{
    constructor(){
...
export function textarea(){return new textarea_()}
...
export class TextInput_ extends SmartdomElement_{
    ...
    getText(){
        return this.text.e.value
    }

    setText(text){
        this.text.e.value = text
        return this
    }
}
...
export class MultipleSelect_ extends SmartdomElement_{    
...
export function MultipleSelect(props){return new MultipleSelect_(props)}

export class hr_ extends SmartdomElement_{
    constructor(){
        super({tagName: "hr"})
    }
}
export function hr(){return new hr_()}
